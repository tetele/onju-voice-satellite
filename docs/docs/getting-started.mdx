...
Congratulations 🎉 You have gone successfully through everything to get started with the Onju Voice Satellite for Home Assistant. If you have any questions, please check the [FAQ page] first and if you can't find the answer there, you can always ask your question on [Github].